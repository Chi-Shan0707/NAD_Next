...
- `math model`：`models/ml_selectors/es_svd_math_rr_r2.pkl`。
- `science model`：`models/ml_selectors/es_svd_science_rr_r2.pkl`。
- `ms model`：`models/ml_selectors/es_svd_ms_rr_r2.pkl`。
- `summary json`：`results/scans/earlystop/es_svd_ms_rr_r2_summary.json`。
- `eval json`：`results/scans/earlystop/es_svd_ms_rr_r2_eval.json`。
