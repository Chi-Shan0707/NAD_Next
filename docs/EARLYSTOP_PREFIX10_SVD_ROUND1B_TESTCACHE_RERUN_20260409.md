...
- `capped screening`：本轮每个 cache 最多使用 `1` 个 problems，用于先把正确协议下的筛选跑通；不是 full-data 终版。
...
| noncoding_anchor4_coding_v1 | N/A | 94.00% | N/A | N/A | 100.00% |
...
- `docs/EARLYSTOP_PREFIX10_SVD_ROUND1B_TESTCACHE_RERUN_20260409.md`
- `scripts/run_earlystop_prefix10_svd_round1b.py`
- `models/ml_selectors/earlystop_prefix10_svd_round1b_testcache_rerun.pkl`
...
- 保存路径：`models/ml_selectors/earlystop_prefix10_svd_round1b_testcache_rerun.pkl`。
