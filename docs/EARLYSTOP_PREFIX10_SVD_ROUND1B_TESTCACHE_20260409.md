...
- `docs/EARLYSTOP_PREFIX10_SVD_ROUND1B_TESTCACHE_20260409.md`
- `scripts/run_earlystop_prefix10_svd_round1b.py`
- `models/ml_selectors/earlystop_prefix10_svd_round1b_testcache.pkl`
...
- 保存路径：`models/ml_selectors/earlystop_prefix10_svd_round1b_testcache.pkl`。
