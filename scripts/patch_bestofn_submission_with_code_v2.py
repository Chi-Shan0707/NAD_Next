...
from nad.core.selectors.code_v2_impl import compute_code_v2_primary_scores
...
DEFAULT_OUT = REPO_ROOT / "submission/BestofN/extreme12/patches/extreme12_baseline12_pointwise_best_only_ref030_t1024_scale100_rank__code_v2_lcb_patch.json"
DEFAULT_CACHE_ROOT = Path("/home/jovyan/public-ro/MUI_HUB/cache_test")
TARGET_CACHE_KEYS = ("DS-R1/lcb_v5", "Qwen3-4B/lcb_v5")
DEFAULT_METHOD_NAME = "extreme12_baseline12_pointwise_best_only_ref030_t1024__code_v2_lcb_patch"
DEFAULT_LCB_OVERRIDE = "code_v2=PrefixSaturationV2Selector@ja_mass1.0"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Patch best_of_n submission with code_v2 lcb_v5 scores")
    ...
    ap.add_argument("--prefix-fraction", type=float, default=0.30)
